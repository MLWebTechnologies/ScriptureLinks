...
balloon.OnCreateContentString = function()
{
	...
	sImgZ = '" style="' + sCss0 + '" />';
	tt_sContent = '<style type="text/css">table.wztable {border-collapse:separate;}table.wztable a {color:' + tt_aV[FONTCOLOR] + ';}tr.wztt td {border:0;border-style:hidden !important;}</style>'
    + '<table class="wztable" border="0" cellpadding="0" cellspacing="0" style="border-style:hidden !important;width:auto;padding:0;margin:0;left:0;top:0;"><tr class="wztt">'
		// Left-top corner
		+ '<td' + sCssCrn + sVaB + '>'
		+ '<img src="' + aImg[1].src + '" width="' + tt_aV[BALLOONEDGESIZE] + '" height="' + tt_aV[BALLOONEDGESIZE] + sImgZ
		+ '</td>'
		// Top border
		+ '<td valign="bottom" style="border:0 none;position:relative;' + sCss0 + '">'
		...
		+ '</td>'
		// Content
		+ '<td id="bALlO0nBdY" style="position:relative;line-height:normal;background-repeat:repeat;white-space:nowrap;'
